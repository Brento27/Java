...
public class League {
    ...
    public static void main(String[] args) {
        ...
        // For loop for if theres more than one goal scored
        for (Goal goal : currGame.goals) {
            System.out.println("Goal scored after " + goal.theTime + 
                " mins by " + goal.thePlayer.playerName + 
                " of " + goal.theTeam.teamName);
        }
